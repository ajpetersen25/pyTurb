...
# flowstats.py
#
# a collections of (hopefully) useful functions and tools for analyzing turbulent flow fields
# focus is on 2D PIV data
###
...
def moving_average(s, window=3):
  """
  Inputs: s       (N,) numpy array:     signal you want to calculate moving average on
          window  int:                  window size you want to use when calculating average
  Outputs:
          ma           numpy array:     calculated moving average
  """
  ma = np.cumsum(s, dtype=float)
